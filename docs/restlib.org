...
- Function: restlib-fetch-json URL ::
  ...
  Any failure in the HTTP request will raise an ~error~ message. Refer to Emacs Lisp Reference Manual for guidance on handling this condition ([[info:elisp#Handling Errors]]).
